    ...
    <form
        ...
        <div class="account-table-content">
            ...
            <div class="row d-flex justify-content-between form-group">
                ...
                <div :class="`col-md-6 col-sm-12 form-group ${errors.has('first_name') ? 'has-error' : ''}`">
                    <label class="mandatory form-label">
                        {{ __('shop::app.customer.account.profile.fname') }}
                    </label>


                    <input value="{{ $customer->first_name }}" class="form-control" name="first_name" type="text" v-validate="'required'"
                ...
                <div :class="`col-md-6 col-sm-12 form-group ${errors.has('last_name') ? 'has-error' : ''}`">
                    <label class="mandatory form-label">
                        {{ __('shop::app.customer.account.profile.lname') }}
                    </label>

                    <input value="{{ $customer->last_name }}" class="form-control" name="last_name" type="text" v-validate="'required'"
