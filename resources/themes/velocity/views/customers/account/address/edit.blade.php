...
@section('page-detail-wrapper')
    <div class=" d-flex account-head mb-15">
        <a class="px-3"
           href="{{ route('customer.address.index') }}"> {!! file_get_contents(public_path('images/Icon.svg')) !!}
        </a>
        <h4 class=" font-weight-bold account-heading">{{ __('shop::app.customer.account.address.edit.title') }}</h4>
    </div>
    ...
    <form method="post" action="{{ route('customer.address.update', $address->id) }}" @submit.prevent="onSubmit">
        <div class="border rounded account-table-content p-4 my-lg-5 my-md-3">
            ...
            <div class="control-group row mb-lg-4 mb-md-2 mt-sm-3">
                ...
                <div class="control-group col-lg-6 col-md-12 control-group" :class="[errors.has('address1[]') ? 'has-error' : '']">
            ...
            <div class="control-group row mb-lg-4 mb-md-2 mt-sm-3">
                ...
                <div class="control-group col-lg-6 col-md-12 control-group" :class="[errors.has('postcode') ? 'has-error' : '']">
                    <label for="postcode"
