...
<div class="d-block" style="position: relative">
    ...
    <img src="{{asset('images/about1.png')}}" class="d-none d-md-block" alt="" style="max-height: 730px;
    object-fit: cover;
    position: absolute;
    top: 0;
    right: 50%;
    ...
    <img src="{{asset('images/about1.png')}}" alt="" class="d-block d-md-none">
    <div class="container">
        ...
        <div class="row ">
            ...
            <div
                ...
                <p style="font-size: 16px">Rodjena i odrasla u Crnoj Gori dizajner Katarina Zlajic, vegan, zaljubljenik
                    u prirodu, biljke i zivotinje, kreativac u svakodnevnom zivotu. Interesovanje za umjetnost i
                    kreiranje ispoljava jos u ranom djetinjstvu. Na zivotnom putu joj dolazi muzika, slikanje, ipak na
                    kraju studira vajarstvo.Pred kraj studija pocinje kreirati nakit u kojem i danas uziva jednako kao i
                    na pocetku.
                    <br><br>
                    Zna da moze otvoriti svoje srce jos vise i zato pokrece "projekat" SHAKA. Shaka etiketa je spremna
                    da prima i daje sa zeljom da zajedno kreiramo, ucimo i rastemo. Zivot je energija, sve je enerija, a
                    energija koja je ovdje privlaci nova iskustva, transformcije, slobodu,znanja. Shaka dizajnira komade
                    u kojima se osjecate lijepo i voljeno, osjecate energiju slobode i znate da ste jedinstveni i
                    zapanjujuci.
                </p>
            </div>
        </div>
...
<div class="d-block" style="position: relative">
    ...
    width: 50vw;
    object-position: left;">
    <img src="{{asset('images/collection1.png')}}" alt="" class="d-block d-md-none">
    <div class="container">
        ...
        <div class="row ">
            ...
            <div
                ...
                <p style="font-size: 16px">The great driver of her creative process is the nature and the material she
                    chooses to make the
